...
@hook.subscribe.startup_once
def set_hdmi_144hz():
    # Add a 2-second delay to ensure display is ready
    import time
    time.sleep(2)
    subprocess.Popen(["xrandr", "--output", "HDMI-1", "--mode", "1920x1080", "--rate", "144"])
...
keys = [
    ...
    Key([mod], "Escape", lazy.spawn("/home/rasa/.config/qtile/powermenu.sh"), desc="Show power menu"),
